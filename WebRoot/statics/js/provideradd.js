...
$(function(){
	...
	var a_companyLicPicPath=$("#a_companyLicPicPath");
	var a_orgCodePicPath=$("#a_orgCodePicPath");
	$(function(){
		if(a_orgCodePicPath.val()==null||a_orgCodePicPath.val()==""){
			a_companyLicPicPath.next().html("*上传大小不能超过500KB * 上传文件类型必须为:jpg、jpeg、png、pneg");
		}else{
			a_companyLicPicPath.next().html(a_orgCodePicPath.val());
		}
