...
<!--头部-->
    <header class="publicHeader">
        ...
        <div class="publicHeaderR">
            ...
            <a href="${pageContext.request.contextPath }/user/sys/logout.html">退出</a>
        </div>
    </header>
<!--时间-->
     ...
     <div class="left">
         ...
         <nav>
             <ul class="list">
              ...
              <li><a href="${pageContext.request.contextPath }/user/sys/pwdmodify.html">密码修改</a></li>
              <li><a href="${pageContext.request.contextPath }/user/sys/logout.html">退出系统</a></li>
             </ul>
         </nav>
     </div>
